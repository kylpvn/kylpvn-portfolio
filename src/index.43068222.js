...
function carousel(root) {
    var figure = root.querySelector("figure"), nav = root.querySelector("nav"), images = figure.children, n = images.length, gap = root.dataset.gap || 0, bfc = "bfc" in root.dataset, theta = 2 * Math.PI / n, currImage = 0;
    ...
    function setupNavigation() {
        ...
        function onClick(e) {
            ...
            if (t.classList.contains("next")) currImage++;
            else currImage--;
            rotateCarousel(currImage);
        }
    }
...
//# sourceMappingURL=index.43068222.js.map
